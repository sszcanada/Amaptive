# Amaptive
The Amaptive project is a collaborative open-source project developed by SSZ Canada and utilizing the advanced capabilities of ChatGPT developed by OpenAI. Its goal is to create a modular, customizable, and adaptable robot platform that utilizes advanced technologies such as AI and VR to control and navigate the robot. The platform is designed for use in education, research, and industry.
